...
export default function BottomNav() {
  ...
  const appPages = ["/chat", "/advisor", "/timeline", "/profile", "/subscription", "/portfolio", "/search", "/goals", "/settings", "/budget", "/compare", "/learn", "/watchlist", "/net-worth", "/news", "/achievements", "/dashboard", "/calculators", "/allocation", "/subscriptions", "/reports", "/screener"];
